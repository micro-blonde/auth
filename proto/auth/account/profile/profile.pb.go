...
var file_account_profile_profile_proto_goTypes = []any{
...
func file_account_profile_profile_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_account_profile_profile_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_account_profile_profile_proto_msgTypes[1].Exporter = func(v any, i int) any {
